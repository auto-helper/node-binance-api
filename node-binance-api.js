...
let api = function Binance(options = {}) {
  ...
  const fBookTickerConvertData = data => {
    let { u: updateId, s: symbol, b: bestBid, B: bestBidQty, a: bestAsk, A: bestAskQty } = data;
    return {
      updateId,
      symbol,
      bestBid,
  ...
  const fUserDataAccountUpdateConvertData = data => {
    let { e: eventType, E: eventTime, T: transaction, a: updateData } = data;
    let updateConverter = updateData => {
      ...
      let balanceConverter = balance => {
        let { a: asset, wb: walletBalance, cw: crossWalletBalance, bc: balanceChange } = balance;
        return {
          asset,
          walletBalance,
          crossWalletBalance,
        ...
        apiRequest(
          ...
          function (error, response) {
            ...
            setTimeout(function userDataKeepAlive() {
              ...
              try {
                apiRequest(
                  base + 'v3/userDataStream?listenKey=' + Binance.options.listenKey,
                  {},
                  function (err) {
        ...
        apiRequest(
          ...
          function (error, response) {
            ...
            setTimeout(function userDataKeepAlive() {
              ...
              try {
                apiRequest(
                  sapi + 'v1/userDataStream?listenKey=' + Binance.options.listenMarginKey,
                  {},
                  function (err) {
                    if (err) setTimeout(userDataKeepAlive, 60000); // retry in 1 minute
                    else setTimeout(userDataKeepAlive, 60 * 30 * 1000); // 30 minute keepalive
        ...
        apiRequest(
          ...
          function (error, response) {
            ...
            setTimeout(function userDataKeepAlive() {
              ...
              try {
                apiRequest(
                  url + 'v1/listenKey?listenKey=' + Binance.options.listenFutureKey,
                  {},
                  function (err) {
                    if (err) setTimeout(userDataKeepAlive, 60000); // retry in 1 minute
                    else setTimeout(userDataKeepAlive, 60 * 30 * 1000); // 30 minute keepalive
        ...
        apiRequest(
          ...
          function (error, response) {
            ...
            setTimeout(function userDataKeepAlive() {
              ...
              try {
                apiRequest(
                  url + 'v1/listenKey?listenKey=' + Binance.options.listenDeliveryKey,
                  {},
                  function (err) {
